...
export function Header({ priorityFilter, onFilterChange, onExportImage, onResetTasks, taskCount, planningTitle, onPlanningTitleChange,}) {
  return (
    <header className="app-header">
      ...
      <input
        ...
        value={planningTitle}
        onChange={(event) =>
          onPlanningTitleChange(
            event.target.value
          )
        }
        placeholder="Nom du planning"
        className="header__planning-input"
      />
    </header>
  )
}
